...
authorization, and recovery gates are approved. Realtime V2 to V1 fallback defaults
to `false`; any downgrade path must be an explicit deployment decision with rollback
evidence.
