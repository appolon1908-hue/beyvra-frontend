...
Most web browsers have cookies enabled and accept cookies automatically, but you can alter the settings of your browser to erase cookies or prevent automatic acceptance if you prefer. Generally you have the option to accept all cookies, to be notified when a cookie is issued or reject all cookies. Visit the ‘options’ or ‘preferences’ menu on your browser to change settings. You can find more information about how to turn off cookies here: <a href='http://www.allaboutcookies.org/manage-cookies/' style={{color:'red'}} target='_blank'>http://www.allaboutcookies.org/manage-cookies/ </a><br/><br/>
Please note that cookies can't harm your computer. We use encrypted information gathered from them to help improve your experience of the Website. For example, they help us to identify and resolve errors, or to determine relevant related products to show you when you're browsing.<br/>
Do not track (DNT) is a feature offered by some browsers, with some newer browsers offering it as default. If you enable it, it sends a signal to websites to request that your browsing isn't tracked.<br/>
We're giving you this information as part of our initiative to both comply with legislation, and make sure we're honest and clear about your privacy when using our Website.</p>
    </div>
  )
}
