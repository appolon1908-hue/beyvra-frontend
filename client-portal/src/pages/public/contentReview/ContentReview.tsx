...
export default function ContentReview() {
  return <main style={{ minHeight: "100svh", background: "var(--color-canvas)", color: "var(--color-text)", padding: "120px 20px", textAlign: "center" }}>
    ...
    <h1>This Beyvra document is not published yet.</h1>
    <p style={{ maxWidth: 560, margin: "16px auto 28px", color: "var(--color-text-secondary)", lineHeight: 1.6 }}>The previous document has been withheld until Beyvra ownership, wording, and effective-date approval are complete.</p>
