export const apiEndpoints = {
  ...
  operations: {
    ...
    reportExports: "v1/reports/exports",
    privacyExports: "v1/privacy/exports",
    deletionRequests: "v1/privacy/deletion-requests",
    sessions: "v1/security/sessions",
    revokeSession: (id: string) => `v1/security/sessions/${encodeURIComponent(id)}/revoke`,
    revokeOtherSessions: "v1/security/sessions/revoke-others",
