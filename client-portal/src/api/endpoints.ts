export const apiEndpoints = {
  ...
  operations: {
    ...
    operatorControlState: "internal/v1/control-state",
    operatorIncidents: "internal/v1/incidents",
    operatorAudit: "internal/v1/audit-timeline",
    operatorFraudCases: "internal/v1/fraud/cases",
    operatorSupportCases: "internal/v1/support/cases",
    operatorAccountSummary: (id: string) => `internal/v1/accounts/${encodeURIComponent(id)}/summary`,
    operatorFreeze: (id: string) => `internal/v1/accounts/${encodeURIComponent(id)}/freeze`,
    operatorTradingHalt: "internal/v1/trading/halt",
    operatorActions: "internal/v1/actions",
    operatorActionApprove: (id: string) => `internal/v1/actions/${encodeURIComponent(id)}/approve`,
    operatorActionExecute: (id: string) => `internal/v1/actions/${encodeURIComponent(id)}/execute`,
  },
  market: {
